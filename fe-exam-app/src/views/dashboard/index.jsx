...
import { Row, Col, Card, Table, Tabs, Tab, Carousel } from 'react-bootstrap';
              ...
              <Carousel>
                <Carousel.Item>
                  <img
                    ...
                    src="https://plus.unsplash.com/premium_photo-1675419532425-e6b52fe24dc5?q=80&w=2074&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Assuming each item has an `image_url`
                    alt={`Slide`}
                    style={{ height: '100vh', objectFit: 'cover', zIndex: 1 }} // Fullscreen image
                  />
                  <Carousel.Caption>
                    <h3 className="text-white">
                      <b>Lorem ipsum dolor sit amet.</b>
                    </h3>{' '}
                    {/* Assuming each item has a `title` */}
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis, sequi.</p>{' '}
                ...
                <Carousel.Item>
                  <img
                    className="d-block w-100"
                    src="https://plus.unsplash.com/premium_photo-1680807869086-e08309acfb24?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Assuming each item has an `image_url`
                    alt={`Slide`}
                    style={{ height: '100vh', objectFit: 'cover', zIndex: 1 }} // Fullscreen image
                  />
                  <Carousel.Caption>
                    <h3 className="text-white">
                      <b>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci, illo.</b>
                    </h3>{' '}
                    {/* Assuming each item has a `title` */}
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Optio unde consectetur rem tempore, quis minus?</p>{' '}
                    {/* Assuming each item has a `description` */}
                  </Carousel.Caption>
                </Carousel.Item>
              </Carousel>
